...
#'
#' The function prints a three-isotope plot on screen and saves the plot as pdf, png and
#' svg. Measured data are compared with Pb isotope ratios measured in PM10 samples from
#' the Northern Hemisphere. Such data are obtained from the dataset \code{pm10nh} from
#' the package \code{pbratios}.
#'
#' @import data.table
#' @import ggplot2
#' @import scales
...
#' @import svglite
#'
#' @param data A data.table generated by corr.mbf function and subsetted to cointain only
#'     samples to be plotted in a three-isotope plot. Data should contain a column
#'     the column "\code{Pb208206}, \code{Pb207206} with the measured Pb isotope ratio
...
#' Generate data points for drawing an ellipse.
#'
#' The function create a dataframe with the points required to plot an allipse.
#'
#' @param x,y Coorinates for the center of the ellipse. Default are \code{0, 0}.
...
#' @param n Number of datapoints to include in the dataset. Default is \code{300}.
#'
#' @return The function returns a dataset of \eqn{x, y} coordinates required to draw an
#'   ellipse with \code{ggplot2}.
#'
#' @examples
#'   nat_local <- get_ellipse(2.044, 0.823, a = 0.003, b = 0.001, angle = 0)
#'
