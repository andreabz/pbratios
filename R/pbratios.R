...
#' \describe{
#' \item{\code{extract_data}}{ Extracts data from the csv report produced by the mass
#'   spectrometer. 208Pb/207Pb, 206Pb/207Pb, 208Pb/206Pb and 207Pb/206Pb ratios
#'   will be taken into account.}
#' \item{\code{calc_ratios}}{ Remove outliers from the dataset and summarise the
#'   replicates.}
#' \item{\code{corr_mbf}}{ Corrects the Pb isotope ratio values for instrumental mass
